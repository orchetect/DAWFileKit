...
extension XMLElement { // MCClip
    ...
    public var fcpMulticamSources: LazyMapSequence<
        LazyFilterSequence<
            LazyMapSequence<
    ...
    > {
        childElements
            .filter(whereElementNamed: FinalCutPro.FCPXML.MCClip.Children.mcSource.rawValue)
            .compactMap(\.fcpAsMulticamSource)
    }
}

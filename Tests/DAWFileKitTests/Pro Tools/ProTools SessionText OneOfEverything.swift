...
class DAWFileKit_ProTools_SessionText_OneOfEverything: XCTestCase {
    ...
    func testSessionText_OneOfEverything() throws {
        ...
        XCTAssertEqual(
            ...
            ProTools.kTimecode(TCC(h: 01, m: 00, s: 06, f: 15), at: ._23_976)
        )
        XCTAssertEqual(
            track2clip1?.endTimecode,
            ProTools.kTimecode(TCC(h: 01, m: 00, s: 10, f: 03), at: ._23_976)
        )
        XCTAssertEqual(
            track2clip1?.duration,
            ProTools.kTimecode(TCC(h: 00, m: 00, s: 03, f: 12), at: ._23_976)
        )
        ...
        XCTAssertEqual(
            ...
            ProTools.kTimecode(TCC(h: 01, m: 00, s: 12, f: 18), at: ._23_976)
        )
        XCTAssertEqual(
            track3clip1?.endTimecode,
            ProTools.kTimecode(TCC(h: 01, m: 00, s: 17, f: 08), at: ._23_976)
        )
        XCTAssertEqual(
            track3clip1?.duration,
            ProTools.kTimecode(TCC(h: 00, m: 00, s: 04, f: 14), at: ._23_976)
        )
        ...
        XCTAssertEqual(
            ...
            ProTools.kTimecode(TCC(h: 01, m: 00, s: 18, f: 17), at: ._23_976)
        )
        XCTAssertEqual(
            track3clip2?.endTimecode,
            ProTools.kTimecode(TCC(h: 01, m: 00, s: 21, f: 19), at: ._23_976)
        )
        XCTAssertEqual(
            track3clip2?.duration,
            ProTools.kTimecode(TCC(h: 00, m: 00, s: 03, f: 02), at: ._23_976)
        )
        ...
        XCTAssertEqual(
            ...
            ProTools.kTimecode(TCC(h: 01, m: 00, s: 05, f: 14), at: ._23_976)
        )
        XCTAssertEqual(
            track5clip1?.endTimecode,
            ProTools.kTimecode(TCC(h: 01, m: 00, s: 11, f: 10), at: ._23_976)
        )
        XCTAssertEqual(
            track5clip1?.duration,
            ProTools.kTimecode(TCC(h: 00, m: 00, s: 05, f: 20), at: ._23_976)
        )
        ...
        XCTAssertEqual(
            marker1?.timecode,
            ProTools.kTimecode(TCC(h: 00, m: 59, s: 58, f: 00), at: ._23_976)
        )

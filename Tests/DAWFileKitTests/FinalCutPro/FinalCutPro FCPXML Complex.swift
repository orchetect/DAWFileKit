...
final class FinalCutPro_FCPXML_Complex: FCPXMLTestCase {
    ...
    lazy var r3Metadata = FinalCutPro.FCPXML.Metadata(fromMetadataElement: r3MetadataXML)
    ...
    lazy var r5Metadata = FinalCutPro.FCPXML.Metadata(fromMetadataElement: r2MetadataXML)

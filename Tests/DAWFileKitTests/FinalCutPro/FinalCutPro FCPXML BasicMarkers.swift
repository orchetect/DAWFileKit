...
final class FinalCutPro_FCPXML_BasicMarkers: FCPXMLTestCase {
    ...
    func testParse() throws {
        ...
        let resources = try XCTUnwrap(fcpxml.resourcesElement?.childElements)
        
        XCTAssertEqual(resources.count, 2)
        
        let r1 = try XCTUnwrap(resources[safe: 0]).fcpAsFormat
        ...
        let r2 = try XCTUnwrap(resources[safe: 1]).fcpAsEffect
        ...
        XCTAssertEqual(sequence.durationTimecode, Self.tc("00:01:03:29", .fps29_97))
